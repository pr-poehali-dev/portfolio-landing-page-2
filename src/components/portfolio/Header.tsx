...
const Header = ({ scrollY }: HeaderProps) => {
  ...
  return (
    <header className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 md:pt-0" id="main">
      <aside className="fixed top-0 left-0 h-24 md:h-full w-full md:w-24 z-30 bg-white md:border-r border-b md:border-b-0 border-gray-200">
        <div className="h-full flex flex-row md:flex-col items-center justify-between md:justify-start p-4">
          <div className="text-xl font-bold">ВФ</div>
          
          <nav className="hidden md:flex flex-col gap-8 mt-20">
            <a href="#main" className="text-sm hover:text-primary transition-colors">
      ...
      <div className="container max-w-5xl mx-auto px-4 md:pl-32 z-10">
        <div className="animate-fade-in opacity-0" style={{animationDelay: "0.2s", animationFillMode: "forwards"}}>
          <h1 className="text-4xl md:text-6xl font-bold mb-6 font-playfair">Василий Фролов</h1>
          <div className="text-xl md:text-2xl mb-8 font-medium h-8">
            <span>{typeText}</span>
          ...
          <p className="text-lg mb-8 max-w-2xl text-muted-foreground">
            Создаю современные сайты и веб-приложения.<br />
