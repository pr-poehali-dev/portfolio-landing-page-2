...
const SkillsSection = ({ isLoaded, skillGroups }: SkillsSectionProps) => {
  return (
    <section className="py-20 bg-slate-50 min-h-screen flex items-center md:pl-24" id="skills">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-2">Мои навыки</h2>
          <p className="text-muted-foreground mb-12 text-lg">Технологии и инструменты, с которыми я работаю</p>
